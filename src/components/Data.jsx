...
// Web Development
import bg from '../assets/images/webDev/bg.png';
import rfwh from '../assets/images/webDev/rfwh.png';
import dr from '../assets/images/webDev/dr.png';
...
// Game Development
import tla from '../assets/images/gameDev/tla.jpg';
...
export const education = [
    {
        ...
        specialization: "Systems engineering: Advanced Automation, Production and Industrial Informatics",
...
export const work = [
    ...
    },
    {
        ...
        description: "R&D: Development of plastic parts for the automotive and home appliance industry",
        adress: "Titu, Romania",
    ...
    },
    {
        title: "Web Developer",
        company: "KonsultHCS",
        description: "Web development: Websites development based on specific templates using a custom CMS",
        adress: "Targoviste, Romania",
...
export const webDev = [
    {
        ...
        path: 'https://cristimanea26.github.io/discover_romania/'
    },
    {
        title: 'RoboFriends with Hooks',
        image: rfwh,
        description: 'Web application developed during the complete web developer 2022 zero to mastery course made with hooks.',
        path: 'https://cristimanea26.github.io/rf_hooks/'
    },
    {
        title: 'RoboFriends with Classes',
        image: rfwh,
        description: 'Web application developed during the complete web developer 2022 zero to mastery course made with classes.',
        path: 'https://cristimanea26.github.io/rf_classes/'
    },
    {
        title: 'Background Generator',
        image: bg,
        description: 'Web application developed during the complete web developer 2022 zero to mastery course.',
...
export const design = [
    {
        title: 'Sazrajh',
        image: sazrajh,
        description: 'Personal project inspired by League of Legends and House of the Dragon TV series.',
...
export const gameDev = [
    {
        ...
        image: tla,
        description: 'This is the game I worked on for 6 months for the Game Cup 1.0 competition.',
        path: 'https://halfroundgames.itch.io/the-last-ancient'
    },
    {
        title: 'Robotic Arm',
        image: bd,
        description: "This is the application I made in Unity for bachelor's degree.",

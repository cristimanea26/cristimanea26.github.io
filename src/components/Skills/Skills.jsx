        ...
        <m.div className='skills'>
            ...
            <div className='skillsContainer'>
                <div className='skillsTop'>
                    <m.div className='skillsInner' variants={fadeIn('right', 'tween', 0.75, 1)} initial='hidden' animate='show'>
                    ...
                    <m.div className='skillsInner' variants={fadeIn('down', 'tween', 0.75, 1)} initial='hidden' animate='show'>
                        <div className='techsTitle'>
                            <h1>Design</h1>
                        </div>
                        <div className='techsList'>
                ...
                <div className='skillsBottom'>
                    <m.div className='skillsInner' variants={fadeIn('up', 'tween', 0.75, 1)} initial='hidden' animate='show'>
                        <div className='techsTitle'>
                            <h1>Game</h1>
                        </div>
                        <div className='techsList'>
                    ...
                    <m.div className='skillsInner' variants={fadeIn('left', 'tween', 0.75, 1)} initial='hidden' animate='show'>
                        <div className='techsTitle'>
                            <h1>Other</h1>
                        </div>
                        <div className='techsList'>

...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_y6ssthb', 'template_ts1gjn9', form.current, '459VfQgE7HmxE-NHB')
          .then((result) => {
    ...
    return (
        <m.div className='contact' variants={fadeIn} initial='hidden' animate='show'>
            ...
            <div className='contactContainer'>
                <m.div className='contactOptions' variants={fadeIn('right', 'tween', 0.75, 1)} initial='hidden' animate='show'>
                ...
                <m.div className='contactForm' variants={fadeIn('left', 'tween', 0.75, 1)} initial='hidden' animate='show'>
                    <form ref ={form} onSubmit={sendEmail}>
                        <input text='text' name='name' placeholder='Name' required/>
                        <input text='email' name='email' placeholder='Email' required/>
                        <input text='subject' name='subject' placeholder='Subject' required/>
